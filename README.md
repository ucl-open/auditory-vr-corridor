...
Stage 4: Same as above, but now mice also punished for excess licking or being slow. Punished on 10th lick before the reward zone AND punished if not ended trial within 10 seconds.
Stage 5: Same as above, but mice punished for 6th wrong lick outside reward zone, AND reward zone shrinks so that there is now also a small 'error zone' after the reward zone.
